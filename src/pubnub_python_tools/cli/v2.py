...
def create_parser():
    ...
    parser.add_argument("--stop-on-fail", action='store_true', help="Stop batch operations if something goes wrong.")
    ...
    parser.add_argument("-ce", "--console-email", type=str, help="Email for Web Console")
    parser.add_argument("-cp", "--console-password", type=str, help="Password for Web Console")
    parser.add_argument("-cl", "--console-login", action='store_true', help="Login to access Web Console api")
    parser.add_argument("-metrics", "--all-metrics", action='store_true', help="Get all app usage metrics. Requires login.")
    ...
    parser.add_argument("-mm", "--multiple-messages", nargs="+", type=str, help="Messages to publish")
